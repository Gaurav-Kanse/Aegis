...
CONFIG_DIR = os.path.expanduser("~/.config/rambo-py")
CONFIG_PATH = os.path.join(CONFIG_DIR, "config.toml")

DEFAULT_CONFIG_CONTENT = """# RamboPy Configuration
...
def load_config() -> Config:
    ...
    if tomllib is not None:
        try:
            ...
            print(f"[rambo-py] Config parse warning: {e}. Using defaults.")
...
def save_config(cfg: Config):
    ...
    content = f"""# RamboPy Configuration
protect = [{protect_str}]
