...
from rambo_py.utils.proc import read_all_proc_samples, uptime_sec, total_ram_kb, ProcessSample
from rambo_py.config import KillWeights

INTERNAL_BLACKLIST = {
    "systemd", "kwin_wayland", "plasmashell", "Xorg", "sddm", "gdm", "lightdm",
    "pipewire", "wireplumber", "pulseaudio", "dbus-daemon", "rambo", "rambo-py",
    "init", "kthreadd"
}
