...
def run_protect(args):
    ...
    if args.subcommand == "list":
        ...
        if args.name not in cfg.protect:
            ...
            save_config(cfg)
            print(f"[rambo-py] Added '{args.name}' to protect list")
        else:
            print(f"[rambo-py] '{args.name}' is already in protect list")
        ...
        if args.name in cfg.protect:
            ...
            save_config(cfg)
            print(f"[rambo-py] Removed '{args.name}' from protect list")
        else:
            print(f"[rambo-py] '{args.name}' not found in protect list")
